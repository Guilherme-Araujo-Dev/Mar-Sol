...
<div class="imagens-index">
    ...
    <div class="imagens">
        <img id="nada"src="comidas/Meu projeto.jpg" alt="nada">
    </div>
    <div class="imagens">
        <img id="quatro" src="comidas/Meu projeto (4).jpg" alt="quatro">
    </div>
    <div class="imagens">
        <img id="dois" src="comidas/Meu projeto (2).jpg" alt="dois">
    </div>
...
<!--TEXTO EM BAIXO DAS IMAGENS--> 
    <div class="container">
        <img src="Imagens/semfundo.png" alt="semfundo">
        <div class="texto">
