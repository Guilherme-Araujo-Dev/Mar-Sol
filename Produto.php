...
BACKGROUND-IMAGE: url(imagens/fundo.jpg)
    ...
    <div class="pp">
        ...
        <div class="imagenss">
            <img src="comidas/Meu projeto (3).jpg" alt="salgado3" width="300px">
            <p>Coxinha de Carne Mini</p>
        </div>
            <br>
        <div class="imagenss">
            <img src="comidas/Meu projeto (4).jpg"alt="salgado4" width="300px">
            <p>Coxinha de Frango Mini</p>
        </div>
            
        <div class="imagenss">
            <img src="comidas/Meu projeto (5).jpg" alt="salgado5" width="300px">
            <p>Coxinha de Frango</p>
        </div>
       <br> 
        <div class="imagenss">
            <img src="comidas/Meu projeto (6).jpg" alt="salgado6" width="300px">
            <p>Coxinha Variados</p>
        </div>

        <div class="imagenss">
            <img src="comidas/Meu projeto (7).jpg"alt="salgado7" width="300px">
            <p>Enrolado de Salsicha Mini</p>
        </div>
        <br>
        <div class="imagenss">
            <img src="comidas/Meu projeto (8).jpg" alt="salgado8" width="300px">
            <p>Pastel de Carne</p>
        </div>

        <div class="imagenss">
            <img src="comidas/Meu projeto (9).jpg" alt="salgado9">
