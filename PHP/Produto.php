...
<header>
    <div class="logozinho">
        ...
        <ul>
            ...
            <b><a href="Produto.php"><li>Produtos</li></a></b>
...
<body>
                                            ...
                                            <!--corpo-->
    <!--
                                IMAGEM EM CIMA DO TITULO PRODUTO
    <div id="mao">
        <img src="../IMG/HHAND.png" alt="hand">
    </div>
    -->
...
BACKGROUND-IMAGE: url(../IMG/imagem_fundo.jpg)
    ...
    <div class="pp">
        ...
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto.jpg" alt="salgado" width="300px">
            <p>Bolinho de batata com carne</p>
        </div>
            
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (1).jpg"alt="salgado1" width="300px">
            <p>Bolinho de Batata com Frango</p>
        </div>
            <br>
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (2).jpg" alt="salgado2" width="300px">
            <p>Bolinho de Carne</p>
        </div>
            
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (3).jpg" alt="salgado3" width="300px">
            <p>Coxinha de Carne Mini</p>
        </div>
            <br>
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (4).jpg"alt="salgado4" width="300px">
            <p>Coxinha de Frango Mini</p>
        </div>
            
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (5).jpg" alt="salgado5" width="300px">
            <p>Coxinha de Frango</p>
        </div>
       <br> 
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (6).jpg" alt="salgado6" width="300px">
            <p>Coxinha Variados</p>
        </div>

        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (7).jpg"alt="salgado7" width="300px">
            <p>Enrolado de Salsicha Mini</p>
        </div>
        <br>
        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (8).jpg" alt="salgado8" width="300px">
            <p>Pastel de Carne</p>
        </div>

        <div class="imagenss">
            <img src="../IMG/comidas/Meu projeto (9).jpg" alt="salgado9">
            <p>Risolis de Carne</p>
        </div>
    </div>
    ...
    <center>
    <br>
        <u><h2>Entre em contato</h2></U>
        <p>Quem experimenta se apaixona, com a excelente<br> qualidade dos produtos Mar e Sol.<br></p><br><br>
        <p>Venha aproveitar essas delicias você também!</p>
    </center>
    </div>
    <br>
    <br>
