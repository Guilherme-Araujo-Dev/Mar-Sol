...
<body>
    ...
    <div class="logozinho">
        ...
        <ul>
            ...
            <b><a href="Sobre nos.php"><li>Sobre nós</li></a></b>
    ...
    <p id="sobree">Situada em Cascavel/PR, nós somos uma fábrica de alimentos industriais que
        a mais de 10 anos atendemos toda região Oeste do Paraná, com muito amor,
        cuidado e dedicação.<br><br>
        Com produtos de qualidade, excelência em atendimento
        e responsabilidade para atender as maiores redes de padarias e supermercados
        da cidade.<br><br>
