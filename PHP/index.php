...
<header>
    ...
    <ul>    
            ...
            <b><a href="index.php"><li>Início</li></a></b>
...
<body>
    ...
    <!--IMAGEM DO MEIO DO SITE DA mar e solsalgados-->
<div class="logotipo">
...
<!--AS 3 IMAGENS DA PÁGINA INDEX-->
<div class="imagens-index">
    

    <div class="imagens">
        <img id="nada"src="../IMG/comidas/Meu projeto.jpg" alt="nada">
    </div>
    <div class="imagens">
    <img id="quatro" src="../IMG/comidas/Meu projeto (4).jpg" alt="quatro">
    </div>
    <div class="imagens">
        <img id="dois" src="../IMG/comidas/Meu projeto (2).jpg" alt="dois">
    </div>

    <h1 class="qualidade">SALGADINHOS DE QUALIDADE</h1>
</div>


<!--TEXTO EM BAIXO DAS IMAGENS--> 
    <div class="containerr">
        
    </div>
    <div class="container">
        <img src="../IMG/semfundo.png" alt="semfundo">

        <p> - O Momento do Sabor, é uma fabrica de alimentos industriais<br>
        que atende toda região <u>Oeste do Paraná</u> e está situada a mais de<br> 10 anos em Cascavel-PR.
        É na melhor companhia que os produtos<br> da Mar e Sol fica <u>ainda melhor!</u> 🤩😋<br><br>
        

        <b>Compartilhe com quem você ama!</b><br> Leve essas delícias para sua casa.
        Sabor com qualidade, e praticidade<br> na sua mesa todos os dias.<br><br> 💛
        Precisou de salgados, <u>ligue Mar e Sol.☎ (45) 3037-7592</u>
        </p>
        <br>
